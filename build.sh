...
curl -Lo /etc/yum.repos.d/peterwu-iosveka-fedora-"${RELEASE}".repo https://copr.fedorainfracloud.org/coprs/peterwu/iosveka/repo/fedora="${RELEASE}"/peterwu-iosveka-fedora-"${RELEASE}".repo
# this installs a package from fedora repos
rpm-ostree install aerc alacritty emacs helix iosevka isync jetbrains-mono-fonts nerd-fonts pass wayfire
