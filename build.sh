...
curl -Lo /etc/yum.repos.d/peterwu-iosevka-fedora-"${RELEASE}".repo https://copr.fedorainfracloud.org/coprs/peterwu/iosevka/repo/fedora="${RELEASE}"/peterwu-iosevka-fedora-"${RELEASE}".repo
# this installs a package from fedora repos
rpm-ostree install aerc alacritty emacs helix iosevka isync jetbrains-mono-fonts nerd-fonts notmuch pass wayfire
